...
function filterUnfundedOnly() {
    ...
    let unfundedGamesOnly = GAMES_JSON.filter ( (game) => {
...
function filterFundedOnly() {
    ...
    let fundedGamesOnly = GAMES_JSON.filter ( (game) => {
        return game.pledged>= game.goal;
    });
...
const unfundedTotalMessage = 
    `A total of $${totalRaised.toLocaleString("en-us")} has been raised for ${totalGames.toLocaleString("en-us")} games. 
    Currently, ${totalGames.toLocaleString("en-us")} game${totalUnfunded==1 ? " is ":  "s are "}left unfunded! 
    We need your help to fund these amazing games!`


// create a new DOM element containing the template string and append it to the description container
const newUnfundedMessage = document.createElement("p");
newUnfundedMessage.innerHTML = unfundedTotalMessage;
descriptionContainer.appendChild(newUnfundedMessage);
